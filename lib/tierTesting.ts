...
export const TIER_DISPLAY: Record<UserTier, {
  ...
  FREE: {
    ...
    features: [
      ...
      'Teaching Blueprint & learning styles',
...
export const PRICING_COMPARISON_ROWS: { name: string; values: string[] }[] = [
  ...
  { name: 'For Parents learning resources',        values: ['✓',           '✓',          '✓',          '✓'] },
  // Scout AI generation
  ...
  { name: 'Scout assessment generator',            values: ['–',           '–',          '✓',          '✓'] },
  ...
  { name: 'Supply Scout (weekly prep view)',        values: ['–',           '✓',          '✓',          '✓'] },
  { name: 'Subject coverage tracker',              values: ['–',           '✓',          '✓',          '✓'] },
  ...
  { name: 'Mastery tracker',                       values: ['–',           '–',          '✓',          '✓'] },
  { name: 'Google Calendar sync',                  values: ['–',           '–',          'Soon',       'Soon'] },
