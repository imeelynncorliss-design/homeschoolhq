    ...
    >
      ...
      >
        ...
        {formattedDescription && (
          <p className="text-sm text-gray-600 mb-6 line-clamp-2">{formattedDescription}</p>
        )}
        <div className="space-y-3">
          ...
          >
            <span>✏️</span><span>Edit Lesson</span>
          </button>
          <button
          ...
          >
            <span>🗑️</span><span>Delete Lesson</span>
          </button>
          <button
            onClick={onClose}
