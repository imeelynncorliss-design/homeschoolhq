    ...
    <>
      ...
      <header id="hr-header-root" style={s.header}>
        ...
        <div style={s.right}>
          ...
          {/* Feedback — desktop shows label, mobile shows icon only */}
          {betaEnabled && userId && orgId && (
            <>
              ...
              <button className="hr-btn hr-feedback-btn hr-mobile-only" onClick={() => setShowFeedback(true)} aria-label="Share feedback">
